...
INSERT INTO Proyectos VALUES (NULL,"Paiporta Universalis 4","Juego de Gran Estrategia",'{"columns": [{"id": 1,"title": "Por empezar","cards": [{"id": 1,"title": "Restaurar HRE","description": "Restaurar el Sagrado Imperio Romano Germánico jugando como Sajonia"     }      ]    },    {      "id": 2,      "title": "En progreso",      "cards": [        {          "id": 2,          "title": "Santiago y cierra, España!",          "description": "Formar España jugando como Navarra"        }      ]    }, {      "id": 3,      "title": "Realizado",      "cards": [        {          "id": 4,          "title": "Dios Bendiga a Fernando",          "description": "Formar España jugando como Aragón"        },{          "id": 5,          "title": "Dios bendiga a Isabel",          "description": "Formar España jugando como Castilla"        }      ]    }  ]}');
